...
const ICON_NAME = 'square-split-horizontal';
const SvgSquareSplitHorizontal = forwardRef<SVGSVGElement, IconProps>(
...
SvgSquareSplitHorizontal.displayName = 'SvgSquareSplitHorizontal';
