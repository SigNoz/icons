   ...
   <svg xmlns="http://www.w3.org/2000/svg" width={16} height={16} fill="none" {...props}>
    <g clipPath="url(#nut-off_svg__a)">
     <path
      ...
      strokeWidth={1.33}
      d="M8 2.667V1.333m0 1.334c2.666 0 5 1.333 5.333 2.666.161.647.469 1.31 1.333 2-.878.105-1.312-.056-2-.666M8 2.667a8 8 0 0 0-1.434.128M3.333 6.667v2.666a4.67 4.67 0 0 0 3.518 4.525c.275.07.535.195.735.395l.414.414.414-.414c.2-.2.46-.326.734-.395a4.67 4.67 0 0 0 2.75-1.96M3.333 6.668c.36.613.655.904 1.333 1.333.968-.431 1.303-.732 1.667-1.333C6.73 7.33 7.1 7.618 8 8M3.333 6.667c-.685.473-1.127.612-2 .666.72-.698 1.171-1.353 1.333-2 .13-.517.56-1.034 1.194-1.473m8.806 2.807v2.228m0-2.228c-.184.597-.446.886-1.037 1.191M1.333 1.333l13.333 13.334"
     />
    </g>
    <defs>
