...
const ICON_NAME = 'info-severity';
const SvgInfoSeverity = forwardRef<SVGSVGElement, IconProps>(
...
SvgInfoSeverity.displayName = 'SvgInfoSeverity';
export default SvgInfoSeverity;
