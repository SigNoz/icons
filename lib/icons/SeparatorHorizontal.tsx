...
const ICON_NAME = 'separator-horizontal';
const SvgSeparatorHorizontal = forwardRef<SVGSVGElement, IconProps>(
...
SvgSeparatorHorizontal.displayName = 'SvgSeparatorHorizontal';
