...
const ICON_NAME = 'grid-2-x-2-check';
const SvgGrid2X2Check = forwardRef<SVGSVGElement, IconProps>(
...
SvgGrid2X2Check.displayName = 'SvgGrid2X2Check';
export default SvgGrid2X2Check;
