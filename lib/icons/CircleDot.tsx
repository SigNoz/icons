...
const ICON_NAME = 'circle-dot';
const SvgCircleDot = forwardRef<SVGSVGElement, IconProps>(
 ({ color = 'currentColor', size, strokeWidth, className, ...props }, ref) => {
  const element = (
   <svg width={16} height={16} fill="none" xmlns="http://www.w3.org/2000/svg" {...props}>
    <g
     clipPath="url(#circle-dot_svg__a)"
     stroke="inherit"
     strokeWidth={1.33}
     strokeLinecap="round"
    ...
    >
     ...
     <path d="M8 8.667a.667.667 0 1 0 0-1.334.667.667 0 0 0 0 1.334Z" />
    </g>
    <defs>
