...
const ICON_NAME = 'square-play';
const SvgSquarePlay = forwardRef<SVGSVGElement, IconProps>(
 ({ color = 'currentColor', size, strokeWidth, className, ...props }, ref) => {
  const element = (
   <svg width={16} height={16} fill="none" xmlns="http://www.w3.org/2000/svg" {...props}>
    ...
    />
    <path
     d="M6 5.333 10 8l-4 2.667V5.333Z"
     stroke="inherit"
     strokeWidth={1.33}
     strokeLinecap="round"
     strokeLinejoin="round"
...
SvgSquarePlay.displayName = 'SvgSquarePlay';
