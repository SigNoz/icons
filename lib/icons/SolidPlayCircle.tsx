...
const ICON_NAME = 'solid-play-circle';
 ...
 ({ color = 'currentColor', size, strokeWidth, className, ...props }, ref) => {
  const element = (
   <svg width={16} height={16} fill="none" xmlns="http://www.w3.org/2000/svg" {...props}>
    ...
    <defs>
     <clipPath id="solid-play-circle_svg__a">
...
SvgSolidPlayCircle.displayName = 'SvgSolidPlayCircle';
export default SvgSolidPlayCircle;
