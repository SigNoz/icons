...
const ICON_NAME = 'solid-x-square';
const SvgSolidXSquare = forwardRef<SVGSVGElement, IconProps>(
...
SvgSolidXSquare.displayName = 'SvgSolidXSquare';
export default SvgSolidXSquare;
