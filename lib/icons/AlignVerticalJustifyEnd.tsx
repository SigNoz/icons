...
const ICON_NAME = 'align-vertical-justify-end';
 ...
 ({ color = 'currentColor', size, strokeWidth, className, ...props }, ref) => {
  const element = (
   <svg xmlns="http://www.w3.org/2000/svg" width={16} height={16} fill="none" {...props}>
    ...
    <defs>
     <clipPath id="align-vertical-justify-end_svg__a">
...
SvgAlignVerticalJustifyEnd.displayName = 'SvgAlignVerticalJustifyEnd';
