...
const ICON_NAME = 'pipeline-passed';
const SvgPipelinePassed = forwardRef<SVGSVGElement, IconProps>(
...
SvgPipelinePassed.displayName = 'SvgPipelinePassed';
export default SvgPipelinePassed;
