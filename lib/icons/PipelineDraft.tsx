...
const ICON_NAME = 'pipeline-draft';
const SvgPipelineDraft = forwardRef<SVGSVGElement, IconProps>(
...
SvgPipelineDraft.displayName = 'SvgPipelineDraft';
export default SvgPipelineDraft;
