...
const ICON_NAME = 'high-severity';
const SvgHighSeverity = forwardRef<SVGSVGElement, IconProps>(
...
SvgHighSeverity.displayName = 'SvgHighSeverity';
export default SvgHighSeverity;
