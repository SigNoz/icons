...
const SvgCloudDownload = forwardRef<SVGSVGElement, IconProps>(
 ({ color = 'currentColor', size, strokeWidth, className, ...props }, ref) => {
  const element = (
   <svg width={16} height={16} fill="none" xmlns="http://www.w3.org/2000/svg" {...props}>
    <path
     d="M2.667 9.933a4.667 4.667 0 1 1 7.806-4.6h1.194a3 3 0 0 1 1.666 5.495M8 8v6m0 0-2.667-2.667M8 14l2.667-2.667"
     stroke="inherit"
     strokeWidth={1.33}
     strokeLinecap="round"
