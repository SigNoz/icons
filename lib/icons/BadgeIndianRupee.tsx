...
const ICON_NAME = 'badge-indian-rupee';
const SvgBadgeIndianRupee = forwardRef<SVGSVGElement, IconProps>(
 ({ color = 'currentColor', size, strokeWidth, className, ...props }, ref) => {
  const element = (
   <svg xmlns="http://www.w3.org/2000/svg" width={16} height={16} fill="none" {...props}>
    ...
    <defs>
     <clipPath id="badge-indian-rupee_svg__a">
...
SvgBadgeIndianRupee.displayName = 'SvgBadgeIndianRupee';
export default SvgBadgeIndianRupee;
