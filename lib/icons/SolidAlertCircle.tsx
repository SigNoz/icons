...
const ICON_NAME = 'solid-alert-circle';
 ...
 ({ color = 'currentColor', size, strokeWidth, className, ...props }, ref) => {
  const element = (
   <svg width={16} height={16} fill="none" xmlns="http://www.w3.org/2000/svg" {...props}>
    ...
    <defs>
     <clipPath id="solid-alert-circle_svg__a">
...
SvgSolidAlertCircle.displayName = 'SvgSolidAlertCircle';
export default SvgSolidAlertCircle;
